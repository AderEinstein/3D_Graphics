	...
	{
		{
			dx::XMMatrixTranspose(
				...
				dx::XMMatrixTranslation(x,0.0f,4.0f + z)*
				dx::XMMatrixPerspectiveLH(1.0f,1.0f * Window::ScreenHeight / Window::ScreenWidth,0.5f,10.0f)
			)
		}
	};

	// Create constant buffer to store a lookup table for cube face colors
